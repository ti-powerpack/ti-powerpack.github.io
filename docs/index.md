...
hero:
  ...
  tagline: Are you writing TI-Basic 8XP programs for Texas TI-83 or TI-84 Plus calculators? Powerpack is a Windows program that compiles and compresses 8XP files to provide new features, trim file size, and make coding a more enjoyable experience.
  actions:
    - text: ⬇︎ Download
      link: /download
    - theme: brand
...
features:
  - # icon: 🌛
    ...
    title: Remove comments, blank lines, and other unnecessary characters
  ...
  - # icon: 😎
    ...
    details: Designed to work with Texas' official TI-Connect CE software, but if you prefer to write your code in text form in another editor, that's supported too.
  ...
  - title: Create label names longer than two characters
    details: You can use longer, descriptive names for labels too.
  ...
  - title: Create reusable snippets of code
    details: Have snippets of code that you'd like to reuse multiple times in your program? In Powerpack you can create an "alias" and then refer to that as many times as you need. If it needs updating, you can do that in a single location.
...
<div class="custom-container" style="margin-top: 32px; font-size: 85%">
  ...
  <p>Powerpack is not affiliated with Texas Instruments in any way. We're just providing software that provides expanded functionality beyond their existing tools.</p>
</div>
