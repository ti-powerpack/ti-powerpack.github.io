...
// To run these tests, we compare two text files: `transformations.input.txt` and `transformations.expected.txt`. 
// The first file contains the input code, and the second file contains the expected output after running the optimization function.
...
// Enable some extra debugging output for the tests, to help with troubleshooting if the test fails
config.debug = true;
